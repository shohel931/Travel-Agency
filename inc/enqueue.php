...
function travel_agency_enqueue() {
...
add_action('wp_enqueue_scripts', 'travel_agency_enqueue');

// Font Awesome and google fornt
function travel_agency_fonts() {
...
add_action('wp_enqueue_scripts', 'travel_agency_fonts');
